...
@Component({
  selector: 'app-settings-application',
  templateUrl: './settings-application.component.html',
  styleUrls: ['./settings-application.component.css']
})

export class SettingsApplicationComponent extends DataTable<SettingsApplication> implements OnInit {
